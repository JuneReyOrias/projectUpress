                ...
                <div class="card-body">
                    ...
                    <div class="track-card-container">
                        ...
                        <div class="track-card">
                            ...
                            $groupedOrders = $OrdersStatus->groupBy('trackno','users_id');
                        @endphp
                        ...
                        <div class="track-card">
                            ...
                            <h5></h5>
                             <span></span><br>
                                ...
                                <p>Order Date: <span class="font-weight-bold">{{ $OrdersStatus->first()->created_at->format('Y-m-d') }}</span></p>
                                @endif
...
@endphp
                                    @if($OrdersStatus->count() > 0)
                                    @foreach ($OrdersStatus as $orders)
                                    ...
                                    <tr class="table-light">
                                        ...
                                        <td>
                                          <a href="{{ route('admin.customerOrders.change', $orders->id) }}" title="view">
...
<script>
  $(document).ready(function() {
      $(document).on('change', '.status-select', function() {
          ...
          $.ajax({
              url: '/admin-view-update-customerOrders/{id}/' + orderId,
              method: 'POST',
