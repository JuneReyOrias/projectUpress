...
@endif
              ...
              <div class="row mb-4">
                ...
                <div>
                  ...
                  <h4 class="mb-3 mb-md-0">Updates on  Services</h4>
                </div>
                <div class="container">
                  ...
                  <div class="content">
                    <form action{{url('Newstore')}} method="post" enctype="multipart/form-data">
                      ...
                      <div class="input-box">
                        ...
                        <input type="text" class="form-control @error('type_services') is-invalid @enderror"value="{{$servicescat->type_services}}" name="type_services" placeholder="Enter offer services"value="{{ old('type_services') }}" readonly>
                        @error('type_services')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                      </div>
                  ...
                  <div class="input-box"id="layoutField">
                    ...
                    @enderror
                            ...
                            <div class="input-box">
                              ...
                              <input type="text" class="form-control @error('description') is-invalid @enderror" name="description"value="{{$servicescat->description}}" placeholder="Enter descripion"value="{{ old('description') }}" >
                              @error('description')
                              <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                            </div>
                            <div class="input-box">
                              ...
                              <select class="form-select @error('category') is-invalid @enderror" name="size" id="size" aria-label="Floating label select e">
                                <option value="{{$servicescat->size}}">{{$servicescat->size}}</option>
                       ...
                       <div id="sizeField"class="input-box" style="display: none;">
                        <div class="input-box"id="sizeField">
                          ...
                          <div class="input-box">
                            ...
                            <input type="text" name="unit" class="form-control @error('unit') is-invalid @enderror" value="{{$servicescat->unit}}" placeholder="Enter quantity" value="{{ old('unit') }}" step="0.01">
                            @error('unit')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="input-box">
                          ...
                          <select class="form-select @error('category') is-invalid @enderror" name="color" id="colors" aria-label="Floating label select e">
                            <option value="{{$servicescat->color}}">{{$servicescat->color}}</option>
                      ...
                      <div class="input-box">
                        ...
                        <input type="number" name="unit_price" class="form-control @error('unit_price') is-invalid @enderror"value="{{number_format($servicescat->unit_price,2)}}" placeholder="Enter unit price" value="{{ old('unit_price') }}" step="0.01" min="0">
                        @error('unit_price')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
